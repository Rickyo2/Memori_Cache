package com.example.memori_cache
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val nmKecamatan = arrayOf(
            "Bukit Intan", "Gabek", "Gerugang", "Girimaya",
        ...
        spnKecamatan.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                val nmKelurahan = when (position) {
                    0 -> arrayOf(
                        "Air Itam", "Air Mawar", "Bacang", "Pasir Putih", "Semabung Lama",
                        "Sinar Bulan", "Temberan"
                    )
                    1 -> arrayOf(
                        "Air Selemba", "Gabek Dua", "Gabek Satu", "Jerambah Gantung",
                        "Selindung", "Selindung Baru"
                    )
                    2 -> arrayOf(
                        "Air Kelapa Tujuh", "Bukit Merapin", "Bukit Sari", "Kacang Pedang",
                        "Taman Bunga ", "Tuatunu"
                    )
                    3 -> arrayOf(
                    ...
                    4 -> arrayOf(
                        "Ampui", "Ketapang", "Lontong Pacur", "Pasir Garam",
                        "Rejosari"
                    )
                    5 -> arrayOf(
                        "Asam", "Bintang", "Gajah Mada", "Keramat", "Masjid Jamik", "Merintang",
                        "Parit Lalang", "Pintu Air"
                    )
                    else -> arrayOf(
